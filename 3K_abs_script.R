...
#Correlations
cor(cbind(abs(GoodLoose_vs_BadLoose$p1_skill[1:1500]),abs(GoodLoose_vs_BadLoose$p1_luck[1:1500])))
...
#Correlations
cor(cbind(abs(GoodLoose_vs_BadLoose$p2_skill[1501:3000]),abs(GoodLoose_vs_BadLoose$p2_luck[1501:3000])))
...
#Correlations
cor(cbind(abs(GoodLoose_vs_Tommy$p2_skill[1501:3000]),abs(GoodLoose_vs_Tommy$p2_luck[1501:3000])))
...
#Correlations
cor(cbind(abs(GoodLoose_vs_Tommy$p1_skill[1:1500]),abs(GoodLoose_vs_Tommy$p1_luck[1:1500])))
...
#Correlations
cor(cbind(abs(GoodLoose_vs_Zelda$p2_skill[1501:3000]),abs(GoodLoose_vs_Zelda$p2_luck[1501:3000])))
...
#Correlations
cor(cbind(abs(GoodLoose_vs_Zelda$p1_skill[1:1500]),abs(GoodLoose_vs_Zelda$p1_luck[1:1500])))
