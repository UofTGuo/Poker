...
mean(GoodLoose_vs_Tommy$p2_luck[5001:10000])
mean(GoodLoose_vs_Tommy$p1_luck[5001:10000])
mean(GoodLoose_vs_Tommy$p2_skill[5001:10000])
mean(GoodLoose_vs_Tommy$p1_skill[5001:10000])
mean(GoodLoose_vs_Tommy$p2_chip[5001:10000])
mean(GoodLoose_vs_Tommy$p1_chip[5001:10000])
sd(GoodLoose_vs_Tommy$p2_luck[5001:10000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p1_luck[5001:10000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p2_skill[5001:10000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p1_skill[5001:10000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p2_chip[5001:10000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p1_chip[5001:10000])/sqrt(5000)
#Correlations
cor(cbind(GoodLoose_vs_Tommy$p1_skill[5001:10000],GoodLoose_vs_Tommy$p1_luck[5001:10000]))

# (GoodLoose|Tommy) GoodLoose is big blind, Tommy is small blind
mean(GoodLoose_vs_Tommy$p1_luck[1:5000])
mean(GoodLoose_vs_Tommy$p2_luck[1:5000])
mean(GoodLoose_vs_Tommy$p1_skill[1:5000])
mean(GoodLoose_vs_Tommy$p2_skill[1:5000])
mean(GoodLoose_vs_Tommy$p1_chip[1:5000])
mean(GoodLoose_vs_Tommy$p2_chip[1:5000])
sd(GoodLoose_vs_Tommy$p1_luck[1:5000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p2_luck[1:5000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p1_skill[1:5000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p2_skill[1:5000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p1_chip[1:5000])/sqrt(5000)
sd(GoodLoose_vs_Tommy$p2_chip[1:5000])/sqrt(5000)
#Correlations
cor(cbind(GoodLoose_vs_Tommy$p2_skill[1:5000],GoodLoose_vs_Tommy$p2_luck[1:5000]))
