...
avg_equity = function(numattable, chips, blinds, dealer, chipstart, decision, num_hand, iters){
  ...
  for(i in 1:num_hand){
    if(cond[i]){
      ...
      #p1_chip[i] = temp[6]
      #p2_chip[i] = temp[5]
      p1_chip[i] = p1_luck[i] + p1_skill[i]
      p2_chip[i] = p2_luck[i] + p2_skill[i]
      #cat(c(temp[2],temp[1],temp[4],temp[3],temp[6],temp[5]),"\n")
      cat(c(temp[2],temp[1],temp[4],temp[3],p2_chip[i],p1_chip[i]),"\n")
    }
  }
...
decision_one = list(zelda, good_loose_player)
decision_two = list(zelda, bad_loose_player)
decision_three = list(zelda, good_tight_player)
decision_four = list(zelda, bad_tight_player)
decision_five = list(zelda,tommy)
decision_six = list(tommy, good_loose_player)
decision_seven = list(tommy,bad_loose_player)
decision_eight = list(tommy,zelda)
decision_nine = list(tommy,zelda)

decision_10 = list(bad_loose_player, bad_tight_player)
decision_11 = list(good_tight_player, bad_tight_player)
decision_12 = list(tommy, zelda)

num_hand = 1000
iters = 1000

avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_one,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_two,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_three,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_four,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_five,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_six,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_seven,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_eight,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_nine,num_hand,iters)
avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_ten,num_hand,iters)