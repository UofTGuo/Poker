...
plot(a1,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(BB) Luck Profit",type = "l",ylim=c(-500,500))
lines(a1_lb, lty = "dashed", col = "red")
lines(a1_ub, lty = "dashed", col = "green")
plot(a2,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(SB) Luck Profit",type = "l",ylim=c(-500,500))
lines(a2_lb, lty = "dashed", col = "red")
lines(a2_ub, lty = "dashed", col = "green")
plot(a3,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(BB) Skill Profit",type = "l",ylim=c(-500,500))
lines(a3_lb, lty = "dashed", col = "red")
lines(a3_ub, lty = "dashed", col = "green")
plot(a4,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(SB) Skill Profit",type = "l",ylim=c(-500,500))
lines(a4_lb, lty = "dashed", col = "red")
lines(a4_ub, lty = "dashed", col = "green")
plot(a5,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(BB) Chips Change",type = "l",ylim=c(-500,500))
lines(a5_lb, lty = "dashed", col = "red")
lines(a5_ub, lty = "dashed", col = "green")
plot(a6,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(SB) Chips Change",type = "l",ylim=c(-500,500))
lines(a6_lb, lty = "dashed", col = "red")
...
plot(b1,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(BB) Luck Profit",type = "l",ylim=c(-500,500))
lines(b1_lb, lty = "dashed", col = "red")
lines(b1_ub, lty = "dashed", col = "green")
plot(b2,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(SB) Luck Profit",type = "l",ylim=c(-500,500))
lines(b2_lb, lty = "dashed", col = "red")
lines(b2_ub, lty = "dashed", col = "green")
plot(b3,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(BB) Skill Profit",type = "l",ylim=c(-500,500))
lines(b3_lb, lty = "dashed", col = "red")
lines(b3_ub, lty = "dashed", col = "green")
plot(b4,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(SB) Skill Profit",type = "l",ylim=c(-500,500))
lines(b4_lb, lty = "dashed", col = "red")
lines(b4_ub, lty = "dashed", col = "green")
plot(b5,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Tight Player(BB) Chips Change",type = "l",ylim=c(-500,500))
lines(b5_lb, lty = "dashed", col = "red")
lines(b5_ub, lty = "dashed", col = "green")
plot(b6,xlab="Number of hands", ylab="Mean profit per hand($)", main = "Good Loose Player(SB) Chips Change",type = "l",ylim=c(-500,500))
lines(b6_lb, lty = "dashed", col = "red")
