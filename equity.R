...
## First num_hand/2 hands, c(1,2) with dealer = 1. c(big blind, small blind)
## From num_hand/2+1 to num_hand hands, c(2,1) with dealer = 1. c(big blind, small blind)
decision_one = list(good_loose_player, bad_loose_player) 
decision_one_reverse = list(bad_loose_player, good_loose_player)
decision_two = list(good_loose_player, good_tight_player)
decision_two_reverse = list(good_tight_player, good_loose_player)
decision_three = list(good_loose_player, bad_tight_player)
decision_three_reverse = list(bad_tight_player,good_loose_player)
decision_four = list(bad_loose_player, good_tight_player)
decision_four_reverse = list(good_tight_player,bad_loose_player)
decision_five = list(bad_loose_player, bad_tight_player)
decision_five_reverse = list(bad_tight_player,bad_loose_player)
decision_six = list(good_tight_player, bad_tight_player)
decision_six_reverse = list(bad_tight_player,good_tight_player)
...
#dec6_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_three_reverse,num_hand,iters)
#dec7_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_four,num_hand,iters)
#dec8_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_four_reverse,num_hand,iters)
#dec9_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_five,num_hand,iters)
#dec10_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_five_reverse,num_hand,iters)
#dec11_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_six,num_hand,iters)
#dec12_result_list = avg_equity(numattable1,chips1,blinds1,dealer1,chipstart1,decision_six_reverse,num_hand,iters)

mean(result_matrix[,1])
mean(result_matrix[,2])
mean(result_matrix[,3])
mean(result_matrix[,4])
mean(result_matrix[,5])
mean(result_matrix[,6])
sd(result_matrix[,1])/sqrt(num_hand)
sd(result_matrix[,2])/sqrt(num_hand)
sd(result_matrix[,3])/sqrt(num_hand)
sd(result_matrix[,4])/sqrt(num_hand)
sd(result_matrix[,5])/sqrt(num_hand)
sd(result_matrix[,6])/sqrt(num_hand)
