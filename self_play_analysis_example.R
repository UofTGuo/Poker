...
### 3K simulation ###
#obtain dataset
GoodTight_vs_GoodTight <- read.csv("https://raw.githubusercontent.com/UofTGuo/Poker/master/simulation_result/3K_hands/GoodTight_vs_GoodTight.csv")

#format data as player perspective over 3000 hands
p1_luck <- c(GoodTight_vs_GoodTight[-1][1:1500,1],GoodTight_vs_GoodTight[-1][1501:3000,2])
p2_luck <- c(GoodTight_vs_GoodTight[-1][1:1500,2],GoodTight_vs_GoodTight[-1][1501:3000,1])
p1_skill <- c(GoodTight_vs_GoodTight[-1][1:1500,3],GoodTight_vs_GoodTight[-1][1501:3000,4])
p2_skill <- c(GoodTight_vs_GoodTight[-1][1:1500,4],GoodTight_vs_GoodTight[-1][1501:3000,3])
p1_chips <- c(GoodTight_vs_GoodTight[-1][1:1500,5],GoodTight_vs_GoodTight[-1][1501:3000,6])
p2_chips <- c(GoodTight_vs_GoodTight[-1][1:1500,6],GoodTight_vs_GoodTight[-1][1501:3000,5])
datta <- data.frame(p1_luck,p2_luck,p1_skill,p2_skill,p1_chips,p2_chips)
#summary stats
colMeans(datta)
apply(datta,2,sd)/sqrt(3000)
...
plot(1:nrow(gtbl), gt_avg_skill, type="l", col="green", lwd=2,
	xlab="Hand Number", ylab="Average Equity", main="Iterated Average of Equity for GoodTight Self Play")
points(1:nrow(gtbl), gt_avg_skill - 1.96*gt_se_skill, type="l", lty=2, col="darkgrey")
points(1:nrow(gtbl), gt_avg_skill + 1.96*gt_se_skill, type="l", lty=2, col="darkgrey")
points(1:nrow(gtbl), gt_avg_luck, type="l", col="red", lwd=2)
points(1:nrow(gtbl), gt_avg_luck - 1.96*gt_se_luck, type="l", lty=2, col="black")
...
### 10K simulation ###
#obtain data
GoodTight_vs_GoodTight10k <- read.csv("https://raw.githubusercontent.com/UofTGuo/Poker/master/simulation_result/10K_hands/GoodTight_vs_GoodTight.csv")

#reformat
p1_luck <- c(GoodTight_vs_GoodTight10k[-1][1:5000,1],GoodTight_vs_GoodTight10k[-1][5001:10000,2])
p2_luck <- c(GoodTight_vs_GoodTight10k[-1][1:5000,2],GoodTight_vs_GoodTight10k[-1][5001:10000,1])
p1_skill <- c(GoodTight_vs_GoodTight10k[-1][1:5000,3],GoodTight_vs_GoodTight10k[-1][5001:10000,4])
p2_skill <- c(GoodTight_vs_GoodTight10k[-1][1:5000,4],GoodTight_vs_GoodTight10k[-1][5001:10000,3])
p1_chips <- c(GoodTight_vs_GoodTight10k[-1][1:5000,5],GoodTight_vs_GoodTight10k[-1][5001:10000,6])
p2_chips <- c(GoodTight_vs_GoodTight10k[-1][1:5000,6],GoodTight_vs_GoodTight10k[-1][5001:10000,5])
datta10k <- data.frame(p1_luck,p2_luck,p1_skill,p2_skill,p1_chips,p2_chips)
#summary stats
colMeans(datta10k)
apply(datta10k,2,sd)/sqrt(10000)
